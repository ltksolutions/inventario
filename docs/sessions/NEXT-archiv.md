...
Chronologický archív stavov zo session logov. **Toto nie je pracovný
zoznam** — aktívne a plánované veci sú v `NEXT.md`.

Sem sa presúva sekcia, keď je jej práca hotová a nasadená. Ak v nej
ostal skutočne otvorený bod, presunul sa do `NEXT.md`; zvyšné „Otvorené"
riadky sú historické (overovacie kroky, ktoré medzitým prebehli, alebo
follow-upy uzavreté neskoršou sekciou).

Archivované 2026-08-31.
