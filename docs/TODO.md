...
| Atribút                   | Hodnota                                                                                                                                         |
| ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| **Posledná aktualizácia** | 2026-07-06 (UI/UX tlačidlá, veľké písmená tagov, normalizácia voľného textu + backfill, viď `docs/sessions/NEXT.md`; backlog nižšie beze zmeny) |
