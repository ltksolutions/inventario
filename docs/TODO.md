...
| Atribút                   | Hodnota                                                                                                                                       |
| ------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| **Posledná aktualizácia** | 2026-07-07 (zvyšné UI/UX drobnosti + SelectField fix na Lokality/Kategórie dialógoch, viď `docs/sessions/NEXT.md`; backlog nižšie beze zmeny) |
