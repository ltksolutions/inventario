...
| Atribút                   | Hodnota                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Posledná aktualizácia** | 2026-07-14 (zlúčenie „Osoby" + „Používatelia" do jednej stránky /users, K1–K4 hotové, K5 cleanup čaká na Janikino potvrdenie, viď `docs/sessions/NEXT.md`; predtým pomalý preloader po nečinnosti — diagnostikované (cold-start serverless instancií) + fix nasadený (staleTime pre referenčné dáta + Vercel Cron keep-warm); predtým ADR-0034 — predpríprava budúceho používateľa pre DOMAIN_RESTRICTED organizácie, K1–K5 hotové, K6 openapi/api-types regen ostáva ako lokálny krok; predtým QR obrázok s logom, dependabot PR triage + prod incident `ERR_REQUIRE_ESM` (vyriešené), ADR-0027 write path gap doplnený, Zebra UI prepínač + záložky v Nastaveniach organizácie; backlog nižšie beze zmeny — ad-hoc feature požiadavky mimo formálny backlog) |
