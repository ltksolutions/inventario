...
| Atribút                   | Hodnota                                                                                                                                                                          |
| ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Posledná aktualizácia** | 2026-07-07 (číselník Tagov + kompletný Audit log pre správcov, viď `docs/sessions/NEXT.md`; backlog nižšie beze zmeny — obe ako ad-hoc feature požiadavky mimo formálny backlog) |
