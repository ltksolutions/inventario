...
| Atribút                   | Hodnota                                                                                                                                                                                                                                                                                                 |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Posledná aktualizácia** | 2026-07-14 (QR obrázok s logom, dependabot PR triage + prod incident `ERR_REQUIRE_ESM` (vyriešené), ADR-0027 write path gap doplnený, Zebra UI prepínač + záložky v Nastaveniach organizácie, viď `docs/sessions/NEXT.md`; backlog nižšie beze zmeny — ad-hoc feature požiadavky mimo formálny backlog) |
