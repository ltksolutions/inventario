...
| Atribút                   | Hodnota                                                                                                                                                                                                        |
| ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Posledná aktualizácia** | 2026-07-07 (číselník Tagov + kompletný Audit log pre správcov + bug fix legacy záznamov (`db15c3c`), viď `docs/sessions/NEXT.md`; backlog nižšie beze zmeny — ad-hoc feature požiadavky mimo formálny backlog) |
