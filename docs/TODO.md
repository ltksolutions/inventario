...
| Atribút                   | Hodnota                                                                                                                                                            |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Posledná aktualizácia** | 2026-07-06 (perf `/assets`, autoscroll/focus formuláre, ignoreCommand, tagy — normalizácia + autocomplete, viď `docs/sessions/NEXT.md`; backlog nižšie beze zmeny) |
